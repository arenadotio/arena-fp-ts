...
import { Apply, Apply1, Apply2, Apply2C, Apply3, Apply3C, Apply4, sequenceT } from "fp-ts/lib/Apply";
...
export interface Wrapper4<F extends URIS4> {
    ...
    <S, R, E, A>(prolog: Kind4<F, S, R, E, any>, ma: Kind4<F, S, R, E, A>, epolog: Kind4<F, S, R, E, any>): Kind4<F, S, R, E, A>;
}
