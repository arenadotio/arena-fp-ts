 ...
 * @since 0.0.1
 */
export function wrapWithContextT<F extends URIS4>(F: Chain4<F>): WrapperWithContext4<F>;
export function wrapWithContextT<F extends URIS3>(F: Chain3<F>): WrapperWithContext3<F>;
export function wrapWithContextT<F extends URIS3, E>(F: Chain3C<F, E>): WrapperWithContext3C<F, E>;
export function wrapWithContextT<F extends URIS2>(F: Chain2<F>): WrapperWithContext2<F>;
export function wrapWithContextT<F extends URIS2, E>(F: Chain2C<F, E>): WrapperWithContext2C<F, E>;
export function wrapWithContextT<F extends URIS>(F: Chain1<F>): WrapperWithContext1<F>;
export function wrapWithContextT<F extends URIS>(F: Chain<F>): WrapperWithContext<F>;
